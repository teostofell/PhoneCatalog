...
namespace CatalogApp.DAL.Contexts
{
    public class DbInitializer : DropCreateDatabaseAlways<CatalogContext>
    {
        ...
        {           
            Brand b1 = new Brand() { Name = "Samsung" };
            Brand b2 = new Brand() { Name = "Apple" };
            Brand b3 = new Brand() { Name = "LG" };
            Brand b4 = new Brand() { Name = "Sony" };

            context.Brands.AddRange(new List<Brand>() { b1, b2, b3, b4 });


            OS os1 = new OS() { Name = "Android" };
            OS os2 = new OS() { Name = "IOS" };
            OS os3 = new OS() { Name = "WinMobile" };
            ...
            context.Phones.AddRange(new List<Phone>() { p1, p2 });
        }
    }
}